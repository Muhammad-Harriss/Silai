...
class _ClientSignInScreenState extends State<ClientSignInScreen> {
  ...
  Future<void> _signIn() async {
    ...
    try {
      final res = await _supabaseService.signIn(
      ...
      if (role != 'client') {
        ...
        ScaffoldMessenger.of(localContext).showSnackBar(
          SnackBar(
            content: const Text('This account is not registered as a client.'),
            backgroundColor: Colors.red.shade600,
            behavior: SnackBarBehavior.floating,
            margin: const EdgeInsets.all(16),
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
      ...
      if (!mounted) return;
      Navigator.pushNamedAndRemoveUntil(localContext, AppRoutes.clientHome, (r) => false);
    } catch (e) {
      if (!mounted) return;
      ScaffoldMessenger.of(localContext).showSnackBar(
        SnackBar(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Sign in to find tailors and manage bookings',
                        style: GoogleFonts.poppins(
                          fontSize: 14,
